...
import { FiCalendar, FiCheckCircle, FiClock, FiChevronLeft, FiChevronRight, FiFileText } from "react-icons/fi";
...
export default function BookingsPage() {
    const { bookingsData, isLoading, invoicesData } = useDashboardData();

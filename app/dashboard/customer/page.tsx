...
export default function ModernDashboardDark() {
  ...
  const bookings = [
    ...
    {
      branch: "XYZ Auto Care",
      status: "Pending",
      vehicle: "Toyota Camry",
      service: "Full Service",
      time: "Dec 17, 11:30 am",
      progress: 0,
  ...
  const notifications = [
    ...
    {
      icon: "⚠️",
      message: "Toyota Camry next service due Dec 30",
      time: "2 days ago",
    },
            ...
            {[...Array(31)].map((_, i) => {
              ...
              return (
                <button
                  ...
                  className={`py-2 rounded-lg ${bg} ${
                    day === selectedDate ? "ring-2 ring-blue-500" : ""
                  }`}
                >
                  {day}
                </button>
        ...
        <div className="bg-white rounded-3xl p-6 shadow">
          ...
          <div className="space-y-4">
            {bookings.map((b, i) => (
              <div
                key={i}
                className={`p-4 rounded-2xl bg-gradient-to-r ${b.color} text-white`}
              >

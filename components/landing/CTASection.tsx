...
const CTASection = () => {
    return (
        <section className="w-full flex flex-col md:flex-row">
            ...
            {/* Right: Content */}
            <div className="w-full md:w-1/2 bg-white flex flex-col justify-center items-center text-center px-8 md:px-16 py-16">
                <span className="text-[#EA580C] font-bold text-base mb-4 uppercase tracking-wider">CTA</span>
                ...
                <Link
                    href="/signup"
                    className="px-8 py-3.5 bg-gradient-to-b from-[#FF8A00] to-[#E65100] text-white rounded-lg font-bold text-base md:text-lg hover:from-[#E65100] hover:to-[#E65100] transition-all shadow-xl shadow-orange-900/10 transform hover:-translate-y-1"
                >
                    Get Started
                </Link>
            </div>
